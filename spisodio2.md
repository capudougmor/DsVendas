# ![DevSuperior logo](https://raw.githubusercontent.com/devsuperior/bds-assets/main/ds/devsuperior-logo-small.png) Semana Spring React - Epis�dio 2
> Evento gratuito - 3 a 9 de maio/2021
> 
>  *Crie um app in�dito para seu portf�lio com as tecnologias mais demandadas do mercado*

## Realiza��o
[DevSuperior - Escola de programa��o](https://devsuperior.com.br)
...
- Implementar o back end
  ...
  - Consultas agrupadas para gr�ficos
  - Implanta��o na nuvem

## Checklist

- **AVISO: as aulas ficar�o dispon�veis somente at� dia 9 �s 23h59**
...
### Passo 1: configura��o de seguran�a
...
![Image](https://github.com/devsuperior/bds-assets/raw/main/sds/camadas.png "Padr�o camadas")
...
- Pageable
- page, size, sort
- Evitando intera��es repetidas ao banco de dados
- **COMMIT: Pagination**
...
### Passo 6: Valida��o no Postgres local
...
![Parab�ns!](https://raw.githubusercontent.com/devsuperior/bds-assets/main/img/trophy.png)

- Quero muito saber seu feedback
  - O que voc� est� achando da nossa abordagem?
  - Voc� est� conseguindo acompanhar?
  - O que voc� est� achando do evento?
- Participe
  - Comente na p�gina da Semana Spring React
